...
setMethod("layer_arrow_up", "InputHeatmap", function(.data, ...,
                                                     .size = NULL) {
  .data |> layer_symbol(..., symbol = "arrow_up", .size = !!enquo(.size))
})
...
setMethod("layer_arrow_down", "InputHeatmap", function(.data, ...,
                                                       .size = NULL) {
  .data |> layer_symbol(..., symbol = "arrow_down", .size = !!enquo(.size))
})
...
setMethod("layer_point", "InputHeatmap", function(.data, ...,
                                                  .size = NULL) {
  .data |> layer_symbol(..., symbol = "point", .size = !!enquo(.size))
})
...
setMethod("layer_square", "InputHeatmap", function(.data, ...,
                                                   .size = NULL) {
  .data |> layer_symbol(..., symbol = "square", .size = !!enquo(.size))
})
...
setMethod("layer_diamond", "InputHeatmap", function(.data, ...,
                                                    .size = NULL) {
  .data |> layer_symbol(..., symbol = "diamond", .size = !!enquo(.size))
})
...
setMethod("layer_star", "InputHeatmap", function(.data, ...,
                                                 .size = NULL) {
  .data |> layer_symbol(..., symbol = "star", .size = !!enquo(.size))
})
...
setMethod("layer_asterisk", "InputHeatmap", function(.data, ...,
                                                     .size = NULL) {
  .data |> layer_symbol(..., symbol = "asterisk", .size = !!enquo(.size))
})
